# 1월 29일 용산 -> 순천: KTX 일반석, 14시 12분 기차 취소표 매크로 테스트 프로젝트
...
driver.switch_to.window(driver.window_handles[2])
time.sleep(1)
driver.find_element_by_xpath('/html/body/div/div[2]/table/tbody/tr[2]/td[1]/div/div/table/tbody/tr[5]/td[4]').click() #26일
driver.switch_to.window(driver.window_handles[0])
